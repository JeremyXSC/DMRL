...
![GitHub stars](https://img.shields.io/github/stars/JeremyXSC/DMRL.svg?style=flat&label=Star)

# DMRL

## Deep Multimodal Representation Learning for Generalizable Person Reidentification

<img src='images/DMRL.png'/>

This is the official implementation of our paper [Deep Multimodal Representation Learning for Generalizable Person Re-identification](https://arxiv.org/pdf/2211.00933.pdf). And the pretrained models can be downloaded from [data2vec](https://github.com/facebookresearch/data2vec_vision/tree/main/beit).
